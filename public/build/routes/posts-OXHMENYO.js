...
var posts = () => {
  ...
  return /* @__PURE__ */ React.createElement("div", null, "out ", /* @__PURE__ */ React.createElement(import_react_router_dom.Outlet, null), posts2.map((item) => item));
};
var posts_default = posts;
export {
  posts_default as default
};
//# sourceMappingURL=/build/routes/posts-OXHMENYO.js.map
